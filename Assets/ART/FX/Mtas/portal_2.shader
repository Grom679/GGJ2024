...
Shader "Glow"
{
	Properties
	{
		...
		_DOT("DOT", 2D) = "white" {}
		_EMI("EMI", Color) = (0,0,0,0)
		_treshhold("treshhold", Range( 0 , 1)) = 0
		_smooth("smooth", Range( 0 , 1)) = 0
		_twirlSTR("twirlSTR", Range( 0 , 10)) = 0
		_twirlSTR1("twirlSTR", Range( 0 , 10)) = 0
		_twirl_scale("twirl_scale", Range( 0 , 100)) = 0
		_fadeScale("fadeScale", Range( 0 , 100)) = 0
		_EMI_STR("EMI_STR", Range( 0 , 100)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 rotator19 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos19 , -sin19 , sin19 , cos19 )) + float2( 0.5,0.5 );
				float2 center45_g1 = float2( 0.5,0.5 );
				float2 delta6_g1 = ( rotator19 - center45_g1 );
				float angle10_g1 = ( length( delta6_g1 ) * _twirlSTR );
				...
				float4 tex2DNode15 = tex2D( _noise, appendResult44_g1 );
				float2 texCoord23 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos22 = cos( -0.23 * _Time.y );
				float sin22 = sin( -0.23 * _Time.y );
				float2 rotator22 = mul( texCoord23 - float2( 0.5,0.5 ) , float2x2( cos22 , -sin22 , sin22 , cos22 )) + float2( 0.5,0.5 );
				float2 center45_g2 = float2( 0.5,0.5 );
				float2 delta6_g2 = ( rotator22 - center45_g2 );
				float angle10_g2 = ( length( delta6_g2 ) * _twirlSTR1 );
				...
				float4 tex2DNode20 = tex2D( _noise2, appendResult44_g2 );
				
				float2 uv_DOT = IN.ase_texcoord8.xy * _DOT_ST.xy + _DOT_ST.zw;
				

				float3 BaseColor = ( _Color1 * ( tex2DNode15 * tex2DNode20 * _twirl_scale ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _EMI * _EMI_STR ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = _smooth;
				float Occlusion = 1;
				float Alpha = ( tex2DNode15.a * tex2DNode20.a * _twirl_scale * ( tex2D( _DOT, uv_DOT ).r * _fadeScale ) );
				float AlphaClipThreshold = _treshhold;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult44_g2 = (float2(( x23_g2 + break40_g2.x + break41_g2.x ) , ( break40_g2.y + break41_g2.y + y35_g2 )));
				float4 tex2DNode20 = tex2D( _noise2, appendResult44_g2 );
				float2 uv_DOT = IN.ase_texcoord3.xy * _DOT_ST.xy + _DOT_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_DOT = IN.ase_texcoord4.xy * _DOT_ST.xy + _DOT_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_DOT = IN.ase_texcoord2.xy * _DOT_ST.xy + _DOT_ST.zw;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 appendResult44_g2 = (float2(( x23_g2 + break40_g2.x + break41_g2.x ) , ( break40_g2.y + break41_g2.y + y35_g2 )));
				float4 tex2DNode20 = tex2D( _noise2, appendResult44_g2 );
				float2 uv_DOT = IN.ase_texcoord5.xy * _DOT_ST.xy + _DOT_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult44_g2 = (float2(( x23_g2 + break40_g2.x + break41_g2.x ) , ( break40_g2.y + break41_g2.y + y35_g2 )));
				float4 tex2DNode20 = tex2D( _noise2, appendResult44_g2 );
				float2 uv_DOT = IN.ase_texcoord.xy * _DOT_ST.xy + _DOT_ST.zw;
				

				surfaceDescription.Alpha = ( tex2DNode15.a * tex2DNode20.a * _twirl_scale * ( tex2D( _DOT, uv_DOT ).r * _fadeScale ) );
				surfaceDescription.AlphaClipThreshold = _treshhold;
...
Node;AmplifyShaderEditor.FunctionNode;14;-652.8115,-818.022;Inherit;False;Twirl;-1;;1;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RotatorNode;19;-907.5897,-929.715;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;0.2;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1226.71,-966.2899;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-1281.4,-606.5997;Inherit;False;Property;_twirlSTR;twirlSTR;6;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;21;-802.2073,-378.5216;Inherit;False;Twirl;-1;;2;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;23;-1376.106,-526.7895;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RotatorNode;22;-1056.986,-490.2146;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;-0.23;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1430.796,-167.0993;Inherit;False;Property;_twirlSTR1;twirlSTR;7;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;260.3788,-615.3826;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;26;221.8128,-921.698;Inherit;False;Property;_Color1;Color 1;11;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-338.7138,-859.6876;Inherit;True;Property;_noise;noise;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;562.4131,-564.4971;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;219.0234,28.20532;Inherit;False;Property;_treshhold;treshhold;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-77.37186,-50.44465;Inherit;False;Property;_EMI;EMI;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;354.1532,-88.97166;Inherit;False;Property;_smooth;smooth;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;62.40891,-257.9304;Inherit;False;Property;_EMI_STR;EMI_STR;10;0;Create;True;0;0;0;False;0;False;0;0;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;587.4484,-281.6349;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1206.45,-458.2653;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Glow;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;40;Workflow;1;638419746962417822;Surface;1;638419746871390115;  Refraction Model;0;638419729568099882;  Blend;0;638419729409908646;Two Sided;1;638419737161854766;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;20;-516.6157,-578.7904;Inherit;True;Property;_noise2;noise2;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-299.4447,2.434786;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;32;-655.2494,-273.3987;Inherit;True;Property;_DOT;DOT;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;379.556,-438.5728;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-91.88184,-351.8512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-77.67274,-502.3501;Inherit;False;Property;_twirl_scale;twirl_scale;8;0;Create;True;0;0;0;False;0;False;0;0;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-323.7808,-190.7641;Inherit;False;Property;_fadeScale;fadeScale;9;0;Create;True;0;0;0;False;0;False;0;0;0;100;0;1;FLOAT;0
...
WireConnection;28;0;15;4
WireConnection;28;1;20;4
WireConnection;28;2;25;0
WireConnection;28;3;34;0
WireConnection;34;0;32;1
WireConnection;34;1;35;0
ASEEND*/
//CHKSM=BFCE1E69B653ED05AC826F2A799D3F9C309BFE3A